...
<li><a class="" id="home" onclick="AdminPanel('home')" > <span class="glyphicon glyphicon-home"></span> Home</a></li>
<li><a class="" id="card" onclick="AdminPanel('card')"  ><span class="glyphicon glyphicon-credit-card"></span> Credit card  </span></a></li>
<li><a class="" id="article" onclick="AdminPanel('article')" ><span class="glyphicon glyphicon-eye-close"></span> Article  </span></a></li>
<li><a class="" id="client" onclick="AdminPanel('client')"><span class="glyphicon glyphicon-bell"></span> Clients </span></a></li>
<li><a class="" id="facture" onclick="AdminPanel('facture')"><span class="glyphicon glyphicon-list-alt"></span> Factures  </span></a></li>
<li><a class="" id="admin" onclick="AdminPanel('admin')" ><span class="glyphicon glyphicon-user"></span> Profil </span></a></li>
<li><a  id="Livraison" onclick="AdminPanel('Livraison')">  <span class="glyphicon glyphicon-cog"> </span> Livraison  </a></li>
        ...
        echo '<script>    document.getElementById("'.$table.'").className ="active"; </script>';
          ...
          echo'  <div id ="add" class="alert alert-success">
            ...
            ?>
              ...
              <input style=" display:none"  id="input" type="text" name="value" value="">
              <input style="display:none" id="submit" type="submit" name="submit" value="">
              </form>
