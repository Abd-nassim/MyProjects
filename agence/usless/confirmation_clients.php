...
<head>
  <meta charset="UTF-8">
  <title>confirmation Clients</title>
...
<div>
  <table class="table" id="table">
    ...
    $recup = $db->query("SELECT * FROM confirmation ");
  ...
  <form method="post" action="">
    ...
    <tbody>
      <tr>
        ...
        <td><img onclick="modifier('.$result['id'].')" class="img1"   style="padding-right:20px;" src="images/isadmin.png"><img  onclick="supprimer('.$result['id'].' )" class="img1"    style="padding-right:20px;"  src="images/delete.png"></td>
...
function supprimer(id) {
  var txt;
    ...
    if (r == true) {
     ...
     $.post("delete_confirmation.php?id="+id);
